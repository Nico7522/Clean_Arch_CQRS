...
public class UpdateRestaurantCommandHandlerTests
{
    ...
    public UpdateRestaurantCommandHandlerTests()
    {
        ...
        _handler = new UpdateRestaurantCommandHandler(_loggerMock.Object, _restaurantsRepositoryMock.Object, _mapperMock.Object, _restaurantAuthorizationServiceMock.Object);
    ...
    public async Task Handle_WithValidRequest_ShouldUpdateRestaurants()
    {
        ...
        var restaurant = new Restaurant() { Id = restaurantId, Name = "Test", Description = "ttestt" };
    ...
    public async Task Handle_WithUnauthorizedUser_ShouldThrowForbidException()
    {
        ...
        _restaurantsRepositoryMock.Setup(r => r.GetByIdAsync(restaurantId)).ReturnsAsync(restaurant);
        _restaurantAuthorizationServiceMock.Setup(m => m.Authorize(restaurant, Domain.Constants.ResourceOperation.Update)).Returns(false);
